...
export default function Home() {
    ...
    const checkLoggedIn = async () => {
        ...
        axios.post('https://ec2-43-204-100-120.ap-south-1.compute.amazonaws.com:4000/codenest/auth/v1/validateToken', { token })
            .then((resp) => {
    ...
    const handleLogout = async () =>{
        ...
        const resp = await codenest.post("https://ec2-43-204-100-120.ap-south-1.compute.amazonaws.com:4000/codenest/auth/v1/logout",{email:email},{});
